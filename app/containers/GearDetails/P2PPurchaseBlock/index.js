      ...
      {props.width < 1024 ? (
        ...
        <div className='w-full'>
          <div className='w-1/2 float-left'>
            <p className="text-sm font-light text-white mb-0">Current Price</p>
            <div className="font-black text-white md:text-3xl xs:text-xl font-semibold price">
              ${usdprice}
            </div>
          </div>
        </div>
        <div className='w-full flex absolute bottom-4 left-0 right-0'>
        {props.blockleteGolfer === false && (
          <button type="button" className="button disabled ">
            <div className="inner-circle" />
            <div className="inner-shadow" />
            <p className="button-text mb-0">Buy with USD</p>
          </button>
        )}
        ...
        >
          <div className="inner-circle" />
          <div className="inner-shadow" />
          <p className="button-text mb-0">Buy with FUSD</p>
        </button>
        </div>
        </>
      ) : (
