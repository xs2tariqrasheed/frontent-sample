          ...
          <div className="sm:grid grid-cols-12 gap-10 grid-flow-col">
            <section className="col-span-6 mb-10">
              <FormattedMessage {...messages.header}>
                {txt => (
                  <h1 className="text-white callout-underline mb-12 text-4xl tracking-wide font-heavy uppercase">
                    {txt}
                  </h1>
                )}
              </FormattedMessage>
            ...
            <section className="col-span-6 w-full">
              ...
              >
                ...
                <label
                  ...
                  className={`${this.state.isSubmitted &&
                    !this.state.legal &&
                    'invalid-text'} mt-5 inline-block flex items-center`}
                >
                  <input
                    id="legal"
